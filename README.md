...
<img src="https://img.shields.io/badge/java-007396?style=for-the-badge&logo=java&logoColor=white" alt="Java" style="vertical-align: middle;"/>
...
### 문제 풀이
- **시간** : 매주 [풀이 요일/시간]에 문제 풀이를 진행합니다.
- **문제 출처**: 문제는 [LeetCode, Baekjoon, Programmers, SWEA]에서 선정합니다.
- **문제 수**: 각 세션당 [4~6]개의 문제를 풉니다.
...
- **리뷰 시점**: 리뷰는 [리뷰 요일/시간]에 진행합니다.
- **코멘트 규칙**: 코드를 리뷰할 때는 명확한 피드백과 개선 사항을 제시합니다.
...
- **시간**: 매주 [요일] [시간]에 2시간 동안 모의 코딩 테스트를 실시합니다.
...
### 진행 방식
- **모임 주기**: 스터디는 [매주] [요일1]에 진행합니다.
- **진행 형식**: 스터디는 [온라인/오프라인] 형식으로 진행됩니다.
...
2. Commit Message : `문제 이름`으로 통일해 주세요. 
- [Programmers-문제이름] 문제명
- [Baekjoon-문제이름] 문제명

### 📁 파일 및 폴더 구조

1. 프로그래머스  
Programmers/hojun/폴더명/문제명.py  
Programmers/hyunbok/폴더명/문제명.py  
Programmers/jinyoung/폴더명/문제명.py  
Programmers/yuan/폴더명/문제명.py  

2. 백준   
Baekjoon/hojun/폴더명/문제번호_문제명.py   
Baekjoon/hyunbok/폴더명/문제번호_문제명.py   
Baekjoon/jinyoung/폴더명/문제번호_문제명.py   
Baekjoon/yuan/폴더명/문제번호_문제명.py   
...
|-------|-----------------------|-------------------|------------------|----------------|----------------|----------------|-----------------------------|
| 1주차 | greedy & brute_force       | [문제1](#)     | [문제2](#)| [문제 3](#)    | [문제 4](#)    | [문제 5](#)    | [문제 6](#)    | `진행 예정`  |
